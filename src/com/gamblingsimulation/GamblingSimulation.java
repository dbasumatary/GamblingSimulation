...
public class GamblingSimulation {
    ...
    /*Creating a new method to print that gambler would resign for the day if won or lose 50% of stake*/
    public void gamblerResign(int margin){
        double highAmount = EveryDayStake + margin*EveryDayStake/100;            //Upper margin for resigning
        double lowAmount = EveryDayStake - margin*EveryDayStake/100;             //Lower margin for resigning
        double availableAmount = EveryDayStake;                                   //Before the bet they will be same
    ...
    public static void main(String[] args) {
        ...
        GamblingSimulation resignCheck = new GamblingSimulation();
